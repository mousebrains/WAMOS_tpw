...
class NetCDFWriter:
    ...
    def _create_file(self, group_data: dict) -> None:
        ...
        self._nc.createVariable('intensity', 'f4', ('group', 'y', 'x'),
    ...
    def append_group(self, group_data: dict) -> None:
        ...
        self._nc.variables['period'][idx] = nc.stringtochar(
            np.array([period_str], dtype='S64'))
